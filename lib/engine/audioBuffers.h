...
#define AUDIO_IO_BUFFER_SIZE \
	96 // divide by 4 to have the audio latency (in samples)
...
void audio_out_buffer_push(audio_IO_buffer_t *buf, float sample);
...
void audio_in_buffer_pop(audio_IO_buffer_t *buf, float *sample);
